...
local function buildLevel()
    ...
    level = Obst:spawn(level, "square", 43, nil, floorLevelObstacleHeight)
    level = Obst:spawn(level, "square", 43, nil, floorLevelObstacleHeight - 1)

    level = Obst:spawn(level, "endFlag", 55, nil, floorLevelObstacleHeight)
